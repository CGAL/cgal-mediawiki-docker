#This image is a customized version of the MediaWiki image from Synctree, slightly modified to use version 1.27 instead of 1.24

FROM php:5.6-apache
MAINTAINER GeometryFactory <laurent.rineau@cgal.org>

ENV MEDIAWIKI_VERSION=1.27 MEDIAWIKI_FULL_VERSION=1.27.3 TERM=linux
